...
import { B as CirclePlus, D as Heart, E as LayoutDashboard, G as ChevronDown, I as Copy, J as Bell, K as ChartColumn, O as Globe, P as ExternalLink, T as Lightbulb, U as ChevronRight, V as CircleCheck, W as ChevronLeft, X as ArrowRight, Z as ArrowLeftRight, _ as Pin, d as Shield, g as QrCode, i as Users, l as Star, n as X, p as Settings, q as Bug, r as Wallet, w as LoaderCircle, x as Megaphone, y as MessageSquare, z as CircleX } from "../_libs/lucide-react.mjs";
import { t as require_lib } from "../_libs/qrcode.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/DonateModal-CS_QTz2w.js
		...
		children: [
				...
				children: [
					navItems.map((item) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							title: collapsed ? t(item.labelKey) : void 0,
							children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					}), langOpen && !collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: `w-full flex items-center justify-center gap-2 rounded-lg glass-strong hover:border-white/25 text-foreground font-medium text-sm transition h-10 ${collapsed ? "px-0" : "px-3"}`,
					title: collapsed ? wallet.address ?? "" : void 0,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-2 h-2 rounded-full bg-emerald shadow-glow" }), !collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					title: collapsed ? t("connectWallet") : void 0,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Wallet, { className: "w-[18px] h-[18px]" }), !collapsed && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t("connectWallet") })]
				})]
			})
		]
	});
...
function ConnectWalletModal() {
	const { walletModalOpen, closeWalletModal, connectWallet, t } = useApp();
	...
	(0, import_react.useEffect)(() => {
		...
		const has = (prop) => typeof window !== "undefined" && !!window[prop];
		setWalletStatus({
			freighter: has("freighterApi") || has("freighter") || has("getFreighterPublicKey"),
			lobstr: has("lobstr") || has("lobstrWallet"),
			xbull: has("xbull") || has("xbullWallet"),
...
//#endregion
export { DonateModal as n, Sidebar as r, ConnectWalletModal as t };
