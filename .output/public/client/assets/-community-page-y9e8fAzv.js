import { b as Bug, c as Pin, f as Lightbulb, l as MessageSquare, o as Users, u as Megaphone, v as CircleCheck, x as Bell } from "./DonateModal-CW9uRStD.js";
import { _ as __toESM, h as require_react, m as require_jsx_runtime, n as useApp } from "./index-BQzpoh2w.js";
import { n as createLucideIcon } from "./shield-acfSeoTd.js";
import { t as MessageCircle } from "./message-circle-DTDf9cCF.js";
...
function CommunityPage({ channel }) {
	...
	const [posts, setPosts] = (0, import_react.useState)(samplePosts[channel]);
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
										...
										children: [!wallet.connected && "Connect wallet to post — ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Send, { className: "w-3 h-3" }), " Post"]
									})]
								})]
							})]
						})
					}),
					pinned.map((post) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PostCard, {
						post,
						channel,
						onLike: toggleLike
					}, post.id)),
					regular.map((post) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PostCard, {
						post,
						channel,
						onLike: toggleLike
					}, post.id))
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Icon, { className: "w-8 h-8 text-white/90" })
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Posts" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center justify-between",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Members online" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-medium text-emerald",
										children: "142"
									})]
								}),
								(channel === "bugs" || channel === "support") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center justify-between",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Open" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function PostCard({ post, channel, onLike }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [post.pinned && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center gap-1.5 text-[11px] text-primary font-medium mb-3",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pin, { className: "w-3 h-3" }), " Pinned"]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-start gap-3",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							post.status && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: [post.status === "open" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "w-2.5 h-2.5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "w-2.5 h-2.5" }), post.status]
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThumbsUp, { className: `w-3.5 h-3.5 ${post.liked ? "fill-primary" : ""}` }), post.likes]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								className: "inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MessageCircle, { className: "w-3.5 h-3.5" }), post.comments]
							}),
							(channel === "bugs" || channel === "support") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
