...
import { ArrowLeftRight, ArrowRight, ChevronDown, Coins, Eye, Github, Heart, Lock, Megaphone, MessageCircle, Network, Send, Shield, Sparkles, Users, Wallet, Zap } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("button", {
			...
			children: [/* @__PURE__ */ jsx("span", {
				...
				children: q
			}), /* @__PURE__ */ jsx(ChevronDown, { className: `w-5 h-5 text-muted-foreground shrink-0 transition-transform ${open ? "rotate-180" : ""}` })]
		}), /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("main", { children: [
					/* @__PURE__ */ jsxs("section", {
						...
						children: [
							/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-hero pointer-events-none" }),
							/* @__PURE__ */ jsx("div", { className: "absolute inset-0 pointer-events-none [background-image:radial-gradient(oklch(1_0_0/0.04)_1px,transparent_1px)] [background-size:32px_32px] [mask-image:radial-gradient(ellipse_at_center,black_30%,transparent_75%)]" }),
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(Sparkles, { className: "w-3.5 h-3.5 text-emerald" }), "Live on Stellar Mainnet"]
									}),
									/* @__PURE__ */ jsx("div", {
										className: "flex justify-center mb-8 animate-fade-in-up",
										children: /* @__PURE__ */ jsxs("div", {
											className: "relative",
											children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-brand blur-3xl opacity-40" }), /* @__PURE__ */ jsx("div", {
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("button", {
											...
											children: ["Explore Campaigns", /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4" })]
										})]
									})
								]
							})
					...
					/* @__PURE__ */ jsx("section", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								].map((f) => /* @__PURE__ */ jsx(FeatureCard, { ...f }, f.title))
							})]
						})
					}),
					/* @__PURE__ */ jsx("section", {
					...
					/* @__PURE__ */ jsx("section", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-hero opacity-60 pointer-events-none" }), /* @__PURE__ */ jsxs("div", {
								className: "relative",
								children: [
									/* @__PURE__ */ jsx("h2", {
										className: "font-display text-4xl md:text-5xl font-semibold tracking-tight mb-4",
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("button", {
											...
											to: "/create-campaign",
											className: "h-12 px-6 rounded-xl glass hover:border-white/25 text-foreground font-medium inline-flex items-center gap-2 transition",
											children: [/* @__PURE__ */ jsx(Sparkles, { className: "w-4 h-4" }), "Start a Campaign"]
										})]
									})
								]
							})]
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs("a", {
										href: "#",
										className: "px-3 py-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-white/5 transition inline-flex items-center gap-2",
										children: [/* @__PURE__ */ jsx(MessageCircle, { className: "w-4 h-4" }), " Discord"]
									}),
									/* @__PURE__ */ jsxs("a", {
										href: "#",
										className: "px-3 py-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-white/5 transition inline-flex items-center gap-2",
										children: [/* @__PURE__ */ jsx(Send, { className: "w-4 h-4" }), " Feedback"]
									}),
									/* @__PURE__ */ jsx("a", {
										href: "#",
