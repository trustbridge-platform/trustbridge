...
//#region src/routes/create-campaign.tsx?tsr-split=component
var cats = [
	"Food & Water",
	"Disaster Relief",
	"Medical",
	...
	return /* @__PURE__ */ jsx(RequireAuth, { children: /* @__PURE__ */ jsxs(AppShell, {
		...
		children: [success && /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsx(CheckCircle2, { className: "w-5 h-5 text-emerald" })
						...
						children: [
							...
							/* @__PURE__ */ jsx(Field, {
								...
								children: /* @__PURE__ */ jsx("select", {
									...
									className: input,
									children: cats.map((c) => /* @__PURE__ */ jsx("option", { children: c }, c))
								})
							}),
							/* @__PURE__ */ jsx(Field, {
								label: "Location",
				...
				children: [
						...
						children: [
							...
							/* @__PURE__ */ jsxs("label", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsx(Upload, { className: "w-6 h-6 mx-auto text-muted-foreground mb-2" }),
										/* @__PURE__ */ jsx("div", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "w-4 h-4 text-emerald" }), " Verification"]
						}), /* @__PURE__ */ jsx("p", {
