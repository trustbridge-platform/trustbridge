...
function Analytics() {
  ...
  return (
    <AppShell
      title="Analytics"
      subtitle="Real-time impact and donation activity across the network."
      actions={
    ...
    >
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <StatTile label="Total Raised" value="$12.4M" delta="+8.2%" icon={Heart} />
        <StatTile label="Campaigns" value="342" delta="+14" icon={Megaphone} />
        <StatTile label="Beneficiaries" value="89,240" delta="+3.4%" icon={Users} />
        <StatTile label="Transactions" value="1.28M" delta="+11.7%" icon={ArrowLeftRight} />
      </div>
